...
const Login: React.FC = () => {
    ...
    <div className="login-container">
      <form className="login-form" onSubmit={handleSubmit}>
        ...
        <div className="conteinertituloform">
          ...
          <h4 className="subtituloform">Accede a tu cuenta o registra tu empresa</h4>
        </div>
  ...
  <label htmlFor="rememberMe" className="label2"> Recordarme </label>
       ...
       <p className="register-text">¿No tenes cuenta? <strong><a href="/registro">Regístrate acá</a></strong>
    </p>
      </form>
    </div>
  );
